...
//       );
//       console.log("Using back camera:", backCamera);
...
//           boxSize
//         );
//         console.log("Scanning frame imageData:", imageData);
...
//             setTimeout(() => {
//               console.log("Stopping camera after successful detection.");
//               setIsDetecting(false);
//               stopCamera();
//             }, 500);
//           } else {
//             console.warn("Invalid QR code data extracted.");
...
//             width: "90%", // ✅ takes almost full width on mobile
//             maxWidth: "400px", // ✅ restricts on larger screens
//             textAlign: "center",
//           }}
//         >
...
//           <p
//             style={{
//               wordBreak: "break-word", // ✅ handles long QR codes
//               fontSize: "16px",
//               marginBottom: "15px",
//             }}
//           >
        ...
        <ScanButton onClick={handleScanClick}>
          ...
          {qrValue && (
            <div className="mt-4 p-2 bg-green-100 text-green-800 rounded">
              :white_check_mark: QR Code Extracted: {qrValue}
            </div>
          )}
        </ScanButton>
